#ifndef _SOFTARGMAX_PLUGIN_V2_FL_HPP_
#define _SOFTARGMAX_PLUGIN_V2_FL_HPP_
...
const std::string SOFTARGMAX_PLUGIN_TYPE = "Softargmax";
...
class SoftargmaxPluginV2Fl : public nvinfer1::IPluginV2
{
public:
    SoftargmaxPluginV2Fl(const float beta, const float epsilon)
        : mBeta(beta)
        , mEpsilon(epsilon)
    {
    }
    ...
    SoftargmaxPluginV2Fl(const void* data, size_t length)
    {
        ...
        cudaStream_t stream) override
    {
        ...
        softargmax_kernel_fl(stream, inputs, outputs, 1, mInputDims.c(), mInputDims.h(),
        ...
        int index, const nvinfer1::Dims* inputs, int nbInputDims) override
    {
        ...
        case 0:  // preds
            ...
            break;
        case 1:  // confidence
            result = nvinfer1::DimsCHW(inputs[0].d[0], 1, 1);
            break;
        default:
            break;
        }
    ...
    {
        // TODO: understand why nbInputs is 3
        // assert(nbInputs == 1);
        assert(nbOutputs == 2);
    ...
    nvinfer1::IPluginV2* clone() const override { return new SoftargmaxPluginV2Fl(mBeta, mEpsilon); }
...
#endif // _SOFTARGMAX_PLUGIN_V2_FL_HPP_
